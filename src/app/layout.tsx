        ...
        >
          <SmoothScroll>
            ...
            <div className="fixed inset-0 -z-50 w-full h-full overflow-hidden bg-background pointer-events-none">
              <div className="absolute bottom-0 left-0 w-[200%] h-[30vh] md:h-[40vh] opacity-40 dark:opacity-20 animate-wave">
                <svg className="w-full h-full" viewBox="0 0 2000 100" preserveAspectRatio="none">
                  <path d="M0,50 C250,150 750,-50 1000,50 C1250,150 1750,-50 2000,50 L2000,100 L0,100 Z" fill="currentColor" className="text-primary/10 dark:text-primary/20"></path>
                </svg>
              </div>
              <div className="absolute bottom-0 left-0 w-[200%] h-[35vh] md:h-[45vh] opacity-30 dark:opacity-10 animate-wave-reverse">
                <svg className="w-full h-full" viewBox="0 0 2000 100" preserveAspectRatio="none">
